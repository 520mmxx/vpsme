...
```powershell
irm https://gitee.com/opendeepseek/opendeepseek/raw/main/install-cn.ps1 | iex
```
...
```json
{
  ...
  "sources": {
    "gitee": "https://gitee.com/opendeepseek/opendeepseek",
    "gitcode": "https://gitcode.com/opendeepseek/opendeepseek",
