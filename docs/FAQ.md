...
| 平台 | 协议 | 配置位置 | 文档 |
|------|------|---------|------|
| **钉钉** | 钉钉机器人 Webhook + Stream | `.env` | [IM-BRIDGE.md#钉钉](docs/IM-BRIDGE.md#钉钉) |
| **飞书 (Lark)** | 飞书机器人 Webhook / 事件订阅 | `.env` | [IM-BRIDGE.md#飞书](docs/IM-BRIDGE.md#飞书) |
| **企业微信** | 企微机器人 Webhook | `.env` | [IM-BRIDGE.md#企业微信](docs/IM-BRIDGE.md#企业微信) |
...
> 详细步骤、截图指引、常见问题见 **[docs/IM-BRIDGE.md](docs/IM-BRIDGE.md)**。
...
> 还有其他问题？提交 [GitHub Issue](https://github.com/opendeepseek/opendeepseek/issues) 或查看 [完整文档目录](docs/README.md)。
