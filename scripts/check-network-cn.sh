...
probe_url "Gitee raw" "${OPDS_CN_GITEE_RAW:-https://gitee.com/opendeepseek/opendeepseek/raw/main/install-cn.sh}"
probe_url "GitCode raw" "${OPDS_CN_GITCODE_RAW:-https://gitcode.com/opendeepseek/opendeepseek/raw/main/install-cn.sh}"
...
probe_git "Gitee" "${OPDS_CN_GITEE_REPO:-https://gitee.com/opendeepseek/opendeepseek.git}"
probe_git "GitCode" "${OPDS_CN_GITCODE_REPO:-https://gitcode.com/opendeepseek/opendeepseek.git}"
